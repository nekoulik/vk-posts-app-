 ...
 */
export declare const ActionSheetItem: ({ children, autoClose, mode, meta, subtitle, before, after, selectable, value, name, checked, defaultChecked, onChange, onClick, onImmediateClick, multiline, iconChecked, className, isCancelItem, ...restProps }: ActionSheetItemProps) => React.JSX.Element;
