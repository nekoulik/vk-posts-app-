...
import type { AutoPlacementType, FloatingPositionStrategy, Placement, PlacementWithAuto, UseFloatingData } from './types';
 ...
 */
export declare function convertFloatingDataToReactCSSProperties(strategy: FloatingPositionStrategy, x: UseFloatingData['x'], y: UseFloatingData['y'], initialWidth?: React.CSSProperties['width'] | null): React.CSSProperties;
