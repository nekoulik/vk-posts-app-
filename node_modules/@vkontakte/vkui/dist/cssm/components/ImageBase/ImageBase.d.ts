...
export declare const ImageBase: {
    ({ alt, crossOrigin, decoding, loading, referrerPolicy, sizes, src, srcSet, useMap, getRef, size: sizeProp, width: widthImg, height: heightImg, widthSize, heightSize, style, withBorder, fallbackIcon: fallbackIconProp, children, onLoad, onError, withTransparentBackground, ...restProps }: ImageBaseProps): React.JSX.Element;
