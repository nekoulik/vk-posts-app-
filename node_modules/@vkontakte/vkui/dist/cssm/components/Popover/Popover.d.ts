...
export interface PopoverProps extends Omit<PopperCommonProps, 'arrow' | 'arrowClassName' | 'arrowHeight' | 'arrowPadding' | 'ArrowIcon' | 'content'>, Pick<FocusTrapProps, 'restoreFocus'> {
    /**
 ...
 */
export declare const Popover: ({ action, shown: shownProp, showDelay, hideDelay, offsetDistance, content, children, style: styleProp, className, getRef, onShownChange, restoreFocus, ...restProps }: PopoverProps) => React.JSX.Element;
