...
export declare const Placeholder: {
    ({ icon, header, children, action, withPadding, ...restProps }: PlaceholderProps): React.JSX.Element;
    Container: ({ stretched, withPadding, ...restProps }: PlaceholderContainerProps) => React.JSX.Element;
    Icon: (props: PlaceholderIconProps) => React.JSX.Element;
    Header: ({ className, ...restProps }: PlaceholderHeaderProps) => React.JSX.Element;
    Text: ({ className, ...restProps }: PlaceholderTextProps) => React.JSX.Element;
    Actions: (props: PlaceholderActionsProps) => React.JSX.Element;
};
