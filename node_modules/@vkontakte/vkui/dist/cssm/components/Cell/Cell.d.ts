...
import { type CellCheckboxProps } from './CellCheckbox/CellCheckbox';
...
export declare const Cell: {
    ({ mode, onRemove, removePlaceholder, onDragFinish, before, after, disabled, draggable, Component: ComponentProps, onChange, name, value, checked, defaultChecked, getRootRef, draggerLabel, className, style, ...restProps }: CellProps): React.JSX.Element;
