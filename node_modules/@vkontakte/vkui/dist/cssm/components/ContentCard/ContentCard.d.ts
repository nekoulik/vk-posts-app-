 ...
 */
export declare const ContentCard: ({ subtitle, header, text, caption, className, mode, style, getRootRef, getRef, maxHeight, src, srcSet, alt, width, height, crossOrigin, decoding, loading, referrerPolicy, sizes, useMap, hasHover, hasActive, ...restProps }: ContentCardProps) => React.JSX.Element;
