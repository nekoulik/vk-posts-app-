 ...
 */
export declare const ActionSheet: ({ children, className, header, text, style, iosCloseItem, popupDirection, popupOffsetDistance, placement, mode: modeProp, ...restProps }: ActionSheetProps) => React.JSX.Element;
export {};
