...
export declare const Avatar: {
    ({ size, className, gradientColor, initials, fallbackIcon: fallbackIconProp, children, ...restProps }: AvatarProps): React.JSX.Element;
    Badge: ({ className, ...restProps }: import("../ImageBase/ImageBase").ImageBaseBadgeProps) => React.JSX.Element;
    BadgeWithPreset: ({ preset, className, ...restProps }: AvatarBadgeWithPresetProps) => React.JSX.Element;
