...
export declare const HoverPopper: ({ getRef, content, children, onShownChange, shown: _shown, showDelay, hideDelay, ...restProps }: HoverPopperProps) => React.JSX.Element;
//# sourceMappingURL=HoverPopper.d.ts.map