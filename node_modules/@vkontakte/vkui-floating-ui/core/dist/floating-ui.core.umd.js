...
(function(global, factory) {
    (typeof exports === "undefined" ? "undefined" : _type_of._(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports) : typeof define === 'function' && define.amd ? define([
        'exports'
    ], factory) : (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.FloatingUICore = {}));
   ...
   */ var computePosition = function computePosition(reference, floating, config) {
        return _async_to_generator._(function() {
            var _config_placement, placement, _config_strategy, strategy, _config_middleware, middleware, platform, platformWithDetectOverflow, rtl, rects, _computeCoordsFromPlacement, x, y, statefulPlacement, resetCount, middlewareData, i, currentMiddleware, name, fn, _ref, nextX, nextY, data, reset, _tmp, ref;
            return _ts_generator._(this, function(_state) {
                switch(_state.label){
                    case 0:
                        ...
                        platformWithDetectOverflow = platform.detectOverflow ? platform : _object_spread_props._(_object_spread._({}, platform), {
                    ...
                    case 3:
                        ...
                        name = currentMiddleware.name, fn = currentMiddleware.fn;
                        return [
                            4,
                            fn({
                                x: x,
                    ...
                    case 4:
                        ...
                        middlewareData[name] = _object_spread._({}, middlewareData[name], data);
                        if (!(reset && resetCount < MAX_RESET_COUNT)) return [
                            3,
                            10
                        ];
                        resetCount++;
                        if (!((typeof reset === "undefined" ? "undefined" : _type_of._(reset)) === 'object')) return [
                            3,
                            9
                        ];
                        if (reset.placement) {
   ...
   */ var arrow = function arrow(options) {
                    ...
                    return _ts_generator._(this, function(_state) {
                        switch(_state.label){
                            ...
                            case 4:
                                ...
                                return [
                                    2,
                                    (_obj1 = {}, _define_property._(_obj1, axis, coords[axis] + alignmentOffset), _define_property._(_obj1, "data", _object_spread._((_obj = {}, _define_property._(_obj, axis, offset), _define_property._(_obj, "centerOffset", center - offset - alignmentOffset), _obj), shouldAddOffset && {
                                        alignmentOffset: alignmentOffset
                                    })), _define_property._(_obj1, "reset", shouldAddOffset), _obj1)
                                ];
                        }
                    });
                })();
    ...
    function getPlacementList(alignment, autoAlignment, allowedPlacements) {
        var allowedPlacementsSortedByAlignment = alignment ? _to_consumable_array._(allowedPlacements.filter(function(placement) {
            return getAlignment(placement) === alignment;
        })).concat(_to_consumable_array._(allowedPlacements.filter(function(placement) {
            return getAlignment(placement) !== alignment;
                    ...
                    return _ts_generator._(this, function(_state) {
                        switch(_state.label){
                            ...
                            case 2:
                                ...
                                allOverflows = _to_consumable_array._(((_middlewareData$autoP2 = middlewareData.autoPlacement) == null ? void 0 : _middlewareData$autoP2.overflows) || []).concat([
                                    {
                        ...
                        switch(_state.label){
                            ...
                            case 1:
                                ...
                                if (!specifiedFallbackPlacements && hasFallbackAxisSideDirection) {
                                    ;
                                    (_fallbackPlacements = fallbackPlacements).push.apply(_fallbackPlacements, _to_consumable_array._(getOppositeAxisPlacements(initialPlacement, flipAlignment, fallbackAxisSideDirection, rtl)));
                                }
                                placements = [
                                    initialPlacement
                                ].concat(_to_consumable_array._(fallbackPlacements));
                                return [
                                    4,
                                    platform.detectOverflow(state, detectOverflowOptions)
                                ];
                            case 2:
                                ...
                                overflowsData = _to_consumable_array._(overflowsData).concat([
                                    {
                                        placement: placement,
                                        overflows: overflows
                                    }
                                ...
                                if (!overflows.every(function(side) {
                                    ...
                                    if (nextPlacement) {
                                        ...
                                        overflowsData.every(function(d) {
                                            return getSideAxis(d.placement) === initialSideAxis ? d.overflows[0] > 0 : true;
                                        })) {
   ...
   */ var hide = function hide(options) {
                    ...
                    return _ts_generator._(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                ...
                                _evaluate = evaluate(options, state), _evaluate_strategy = _evaluate.strategy, strategy = _evaluate_strategy === void 0 ? 'referenceHidden' : _evaluate_strategy, detectOverflowOptions = _object_without_properties._(_evaluate, [
                                    "strategy"
                                ]);
                                switch(strategy){
                            ...
                            case 1:
                                return [
                                    4,
                                    platform.detectOverflow(state, _object_spread_props._(_object_spread._({}, detectOverflowOptions), {
    ...
    function getBoundingRect(rects) {
        var minX = min.apply(void 0, _to_consumable_array._(rects.map(function(rect) {
            return rect.left;
        })));
        var minY = min.apply(void 0, _to_consumable_array._(rects.map(function(rect) {
            return rect.top;
        })));
        var maxX = max.apply(void 0, _to_consumable_array._(rects.map(function(rect) {
            return rect.right;
        })));
        var maxY = max.apply(void 0, _to_consumable_array._(rects.map(function(rect) {
            return rect.bottom;
        })));
        return {
            x: minX,
                ...
                return _async_to_generator._(function() {
                    ...
                    function getBoundingClientRect() {
                        ...
                        if (clientRects.length >= 2) {
                            ...
                            var maxRight = max.apply(void 0, _to_consumable_array._(clientRects.map(function(rect) {
                                return rect.right;
                            })));
                            var minLeft = min.apply(void 0, _to_consumable_array._(clientRects.map(function(rect) {
                                return rect.left;
                            })));
                            ...
                            case 1:
                                ...
                                return [
                                    2,
                                    {
                                        x: x + diffCoords.x,
                                        y: y + diffCoords.y,
                                        data: _object_spread_props._(_object_spread._({}, diffCoords), {
                                            placement: placement
                                        })
                                    }
                                ];
                    ...
                    return _ts_generator._(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                ...
                                } : _evaluate_limiter, detectOverflowOptions = _object_without_properties._(_evaluate, [
                                    "mainAxis",
                                    "crossAxis",
                                    "limiter"
                                ]);
                            ...
                            case 1:
                                ...
                                limitedCoords = limiter.fn(_object_spread_props._(_object_spread._({}, state), (_obj = {}, _define_property._(_obj, mainAxis, mainAxisCoord), _define_property._(_obj, crossAxis, crossAxisCoord), _obj)));
                                return [
                                    2,
                                    _object_spread_props._(_object_spread._({}, limitedCoords), {
                                        data: {
                                            x: limitedCoords.x - x,
                                            y: limitedCoords.y - y,
                                            enabled: (_obj1 = {}, _define_property._(_obj1, mainAxis, checkMainAxis), _define_property._(_obj1, crossAxis, checkCrossAxis), _obj1)
                                        }
                                    })
                                ];
                        }
        ...
        return {
            ...
            fn: function fn(state) {
                ...
                if (checkCrossAxis) {
                    ...
                    var isOriginSide = originSides.has(getSide(placement));
                ...
                var _obj;
                return _obj = {}, _define_property._(_obj, mainAxis, mainAxisCoord), _define_property._(_obj, crossAxis, crossAxisCoord), _obj;
            }
        };
    };
    /**
                    ...
                    return _ts_generator._(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                ...
                                _evaluate = evaluate(options, state), _evaluate_apply = _evaluate.apply, apply = _evaluate_apply === void 0 ? function() {} : _evaluate_apply, detectOverflowOptions = _object_without_properties._(_evaluate, [
                                    "apply"
                                ]);
                                return [
                                    4,
                            ...
                            case 4:
                                ...
                                return [
                                    4,
                                    apply(_object_spread_props._(_object_spread._({}, state), {
