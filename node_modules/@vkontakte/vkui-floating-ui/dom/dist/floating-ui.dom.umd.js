...
(function(global, factory) {
   ...
   */ var min = Math.min;
    ...
    var isNotNone = function isNotNone(value) {
   ...
   */ function autoUpdate(reference, floating, update, options) {
        ...
        var ancestors = ancestorScroll || ancestorResize ? _to_consumable_array._(referenceEl ? getOverflowAncestors(referenceEl) : []).concat(_to_consumable_array._(floating ? getOverflowAncestors(floating) : [])) : [];
